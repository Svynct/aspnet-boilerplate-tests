...
{
    public abstract class AspNetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspNetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspNetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspNetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspNetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspNetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspNetDbContext, Task<T>> func)
        {
            T result;
